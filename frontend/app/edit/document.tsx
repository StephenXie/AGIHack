    ...
    <div className={`flex flex-col h-screen ${isDarkMode ? 'dark' : ''}`}>
      ...
      <main className="flex-1 flex justify-center items-start p-4 bg-white dark:bg-gray-900 transition-colors duration-200 overflow-auto">
        <div
          ...
          contentEditable
          onInput={handleInput}
          className="w-full max-w-3xl p-4 text-lg font-serif text-gray-800 dark:text-gray-200 bg-transparent outline-none transition-all duration-200 ease-in-out"
          style={{
